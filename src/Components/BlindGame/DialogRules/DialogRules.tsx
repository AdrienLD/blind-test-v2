...
const DialogRules: React.FC<DialogRulesProps> = ({ open, onClose, modifyRules, modeInitial, tempsInitial }) => {
    ...
    <Dialog open={open} onClose={onClose} className='Dialog'>
      <DialogContent className='DialogContent'>
        <div className="DialogTitle">
          ...
          <button onClick={() => modifyRules({ mode: modeSelectionne, temps: tempsEcoute })}>Valider</button>
        </div>
      </DialogContent>
    </Dialog>
  )
